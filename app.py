        ...
        if do_famiglie:
            def gruppi_comuni_per_divisione(df):
                ...
                for divisione in divisioni:
                    ...
                    membri_possessori = {g: list(df_div[df_div['Group Name'] == g]['Member Name']) for g in gruppi_non_comuni}
                    membri_mancanti = {g: list(set(df_div['Member Name']) - set(membri_possessori.get(g, []))) for g in gruppi_non_comuni}
